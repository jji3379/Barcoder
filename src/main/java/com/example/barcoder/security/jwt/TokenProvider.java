package com.example.barcoder.security.jwt;
...
public class TokenProvider {
    ...
    private static final long ACCESS_TOKEN_EXPIRE_TIME = (long)1000 * 60 * 60 * 6;            // 6시간
    private static final long REFRESH_TOKEN_EXPIRE_TIME = (long)1000 * 60 * 60 * 24 * 31 * 6;  // 6개월
